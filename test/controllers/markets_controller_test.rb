...
class MarketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post markets_url, params: { market: { price: @market.price, user_id: @market.user_id } }
    end
  ...
  test "should update market" do
    patch market_url(@market), params: { market: { price: @market.price, user_id: @market.user_id } }
