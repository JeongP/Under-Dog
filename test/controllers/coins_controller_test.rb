...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { post_id: @coin.post_id, reward: @coin.reward, user_id: @coin.user_id } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { post_id: @coin.post_id, reward: @coin.reward, user_id: @coin.user_id } }
